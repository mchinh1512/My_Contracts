...
contract BFI is ERC20 {
    ...
    modifier checkMintedTime() {
        require(block.timestamp >= lastMinted.add(mintingCooldownTime), "less than 72h");
        _;
    }
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "YAX::delegateBySig: signature expired");
    ...
    function safe32(uint n, string memory errorMessage) internal view returns (uint32) {
